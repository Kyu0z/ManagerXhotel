...
import border from "@src/Members/MDK/LandingPage/image/banner/border.png";
  ...
  return (
    <Layout className="banner mb-[10rem]">
      <div className="w-[1357px] h-[525px] my-0 mx-auto md:w-full md:h-[14.5rem] sm:w-full sm:h-[1.5rem]">
        ...
        <Image
          className="rectangle rounded-3xl relative top-[-22px]"
          src={border}
          preview={false}
        />
        <Space
          className="information absolute top-[35rem] left-[12rem] flex items-center justify-between !gap-[25rem] 
